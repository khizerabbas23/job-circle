    ...
    foreach ($post_datas as $post_data) {
        ...
        if ($post_type == 'attachment') {
            ...
            if (is_file($file)) {
                ...
                if (function_exists('jobcircle_demo_data_get_path') && is_dir(jobcircle_demo_data_get_path('content/'))) {
                    if (!is_dir(jobcircle_demo_data_get_path('content/images/'))) {
                        mkdir(jobcircle_demo_data_get_path('content/images/'), 0755);
                    }
                    $img_dir = jobcircle_demo_data_get_path('content/images/');
...
foreach ($all_options as $name => $value) {
    if (stristr($name, 'jobcircle_framework_options') !== false) {
...
if (function_exists('jobcircle_demo_data_get_path')) {
    $dir = jobcircle_demo_data_get_path('content/');
}
