...
add_action( 'vc_before_init', 'sub_header' );

//welcome Massage frontend
function sub_header_frontend( $atts, $content ) {
					...
					<div class="col-12">
                        ...
                        <nav class="breadcrumb-nav text-white d-flex justify-content-center mt-20 mt-lg-40">
							<ul class="breadcrumb mb-0">
                                ...
                                <?php if(!empty($page_name)){?>
                                <li class="breadcrumb-item active"><?php echo esc_html($page_name)?></li>
                                <?php } ?>
							</ul>
						</nav>
					</div>
...
add_shortcode( 'sub_header', 'sub_header_frontend' );