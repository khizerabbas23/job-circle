<?php
function jobcircle_job_list_3_theme_1_left_filter_top() {   
    vc_map(       
       array(
             'name' => __( 'Job List 90' ),
             'base' => 'jobcircle_job_list_3_theme_1_left_filter_top',
...
add_action( 'vc_before_init', 'jobcircle_job_list_3_theme_1_left_filter_top' );
...
function jobcircle_job_list_3_theme_1_left_filter_top_frontend( $atts, $content ) {
    $atts = shortcode_atts(
    array(
        'orderby' => '',
		'numofpost' => '',
    ...
    $atts, 'jobcircle_job_list_3_theme_1_left_filter_top'
    );
 ...
 $atts['listin_ajax_action'] = 'jobcircle_list_3_theme_1_left_filter_top';
	...
	<section class="section section-categories section-theme-1 pt-35 pt-md-50 pt-lg-75 pt-xl-95 pb-35 pb-md-50 pb-xl-75">
                	...
                	if (isset($_REQUEST['keyword'])) {
						...
						?>					
 						...
 						<?php echo jobcircle_jobs_listing_ten_theme90($atts); ?>
										</div>
									</div>
								</div>
							</div>
...
add_shortcode( 'jobcircle_job_list_3_theme_1_left_filter_top', 'jobcircle_job_list_3_theme_1_left_filter_top_frontend' ); 

function jobcircle_jobs_listing_ten_theme90($atts){
	ob_start();
	 ...
	 while ( $query->have_posts() ) {
		...
		$job_type_str = jobcircle_job_type_ret_str($job_type);
			...
			?>
			{
				...
				// siteLink: "<a href='<?php echo get_permalink(); ?>' target='_blank'><?php esc_html_e('Site Link','jobcircle-frame')?></a>",
			},
			<?php
                       ...
                       <div class="col-12 col-sm-6 col-xxl-4 mb-15 mb-md-30">
							...
							$counter++;
										...
										<div class="textbox">
											...
											<a href="<?php echo esc_html($post_author_url) ?>" class="myclass"><?php echo esc_html($post_author_name) ?></a></span>
										<?php  } 
...
<a href="javascript:;" class="jobcircle-det-applybtn btn btn-dark-yellow btn-sm jobdet-applybtn-act jobcircle-aplybtn-con" data-id="<?php echo esc_html($post) ?>"
								...
								<?php    }  ?>
                                		...
                                		<?php }else{
											...
											<?php if(!empty($post_author_url) && !empty($post_author_name)){     ?>
												<li>													    
												<span class="text"><?php esc_html_e('By', 'jobcircle-frame') ?><a href="<?php echo esc_html($post_author_url) ?>" class="myclass"><?php echo esc_html($post_author_name) ?></a></span>													
												</li>
													<?php   }  
													if(!empty($job_location)) { ?>
													<li>
...
add_action('wp_ajax_jobcircle_list_3_theme_1_left_filter_top', 'jobcircle_list_3_theme_1_left_filter_top');
add_action('wp_ajax_nopriv_jobcircle_list_3_theme_1_left_filter_top', 'jobcircle_list_3_theme_1_left_filter_top');

function jobcircle_list_3_theme_1_left_filter_top()
{
	...
	$html = jobcircle_jobs_listing_ten_theme90($atts);
