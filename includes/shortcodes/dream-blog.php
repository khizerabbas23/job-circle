...
add_action('vc_before_init', 'jobcircle_dream_blog');

// popular category frontend
function jobcircle_dream_blog_frontend($atts, $content)
{
...
add_shortcode('jobcircle_dream_blog', 'jobcircle_dream_blog_frontend');
