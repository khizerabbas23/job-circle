<?php
function jobcircle_company_banner(){
     $terms = get_terms(
		array(
    ...
    vc_map(
        array(
            'name' => __('Company Search Banner'),
            'base' => 'jobcircle_company_banner',
...
add_action('vc_before_init', 'jobcircle_company_banner');
function jobcircle_company_banner_frontend($atts, $content)
{
...
?>
 ...
 <div class="subvisual-block bg-dark-green d-flex align-items-center pt-100 pt-md-140 pt-xl-180 pt-xxl-230 pb-40 pb-md-70 pb-lg-50 pb-xl-65 text-white">
...
<?php } ?>
			...
			<div class="container position-relative text-center">
              ...
              <span class="icon mt-10"><img src="<?php echo Jobcircle_Plugin::root_url()?>/images/bars.png" width = "20" alt ="category icon"></span>
									<select class="select2 select2-hidden-accessible" name="job_category" data-placeholder="<?php esc_html_e('Choose Category', 'jobcircle-frame') ?>">
...
add_shortcode('jobcircle_company_banner', 'jobcircle_company_banner_frontend');