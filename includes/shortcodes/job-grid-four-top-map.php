...
<a href="javascript:;" class="jobcircle-det-applybtn jobdet-applybtn-act btn btn-dark-yellow btn-sm jobcircle-aplybtn-con" data-id="<?php echo esc_html($job_id); ?>"
...
?>
					...
					data: {
						post_id: post_id,
						action: 'jobcircle_candidate_fav_job_jobcircle_job_grid_sev'
					},
					success: function(data) {
					...
					data: {
					post_id: post_id,
					action: 'jobcircle_candidate_remove_job_ljobcircle_job_grid_sev'
					},
					success: function(data) {
					var totalFavorites = data.total_favorites;
...
add_action('wp_ajax_jobcircle_candidate_fav_job_jobcircle_job_grid_sev', 'jobcircle_candidate_fav_job_jobcircle_job_grid_sev');
add_action('wp_ajax_nopriv_jobcircle_candidate_fav_job_jobcircle_job_grid_sev', 'jobcircle_candidate_fav_job_jobcircle_job_grid_sev');
function jobcircle_candidate_fav_job_jobcircle_job_grid_sev() {
    global $current_user;
    $user_id = $current_user->ID;
...
add_action('wp_ajax_jobcircle_candidate_remove_job_ljobcircle_job_grid_sev', 'jobcircle_candidate_remove_job_ljobcircle_job_grid_sev');
add_action('wp_ajax_nopriv_jobcircle_candidate_remove_job_ljobcircle_job_grid_sev', 'jobcircle_candidate_remove_job_ljobcircle_job_grid_sev');
function jobcircle_candidate_remove_job_ljobcircle_job_grid_sev() {
    global $current_user;
    $user_id = $current_user->ID;
    $post_id = $_POST['post_id'];
    $faver_jobs = get_user_meta($user_id, 'fav_follower_list', true);
