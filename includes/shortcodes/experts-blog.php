<?php
function jobcircle_experts_blog() {
    $terms = get_terms(
		array(
			'taxonomy' => 'category',
			'hide_empty' => true,
    ...
    vc_map(
        array(
             'name' => __('Experts Blog'),
             'base' => 'jobcircle_experts_blog',
...
add_action( 'vc_before_init', 'jobcircle_experts_blog' );

// popular category frontend
function jobcircle_experts_blog_frontend( $atts, $content ) {
...
add_shortcode( 'jobcircle_experts_blog', 'jobcircle_experts_blog_frontend' );