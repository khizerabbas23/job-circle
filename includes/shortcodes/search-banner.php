<?php
function jobcircle_home_banner()
{
     $terms = get_terms(
		array(
...
add_action('vc_before_init', 'jobcircle_home_banner');
function jobcircle_home_banner_frontend($atts, $content)
{
...
add_shortcode('jc_home_banner', 'jobcircle_home_banner_frontend');