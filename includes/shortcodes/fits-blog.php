<?php
function jobcircle_fits_blog() {   
    vc_map(       
       array(
             'name' => __( 'Fits Blog' ),
             'base' => 'jobcircle_fits_blog',
...
add_action( 'vc_before_init', 'jobcircle_fits_blog' );

// popular category frontend
function jobcircle_fits_blog_frontend( $atts, $content ) {
...
add_shortcode( 'jobcircle_fits_blog', 'jobcircle_fits_blog_frontend' );
