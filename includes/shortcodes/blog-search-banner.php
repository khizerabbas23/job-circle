...
function blog_sub_header() {
    ...
    vc_map(
        array(
            'name' => __( 'Blog Sub Header' ),
            'base' => 'blog_sub_header',
...
add_action( 'vc_before_init', 'blog_sub_header' );

//welcome Massage frontend
function blog_sub_header_frontend( $atts, $content ) {
				...
				<div class="row">
					<div class="col-12">
						<div class="subvisual-textbox">
							...
							<h1><?php jobcircle_esc_the_html($page_name)?></h1>
							<?php } ?>
							 <?php if(!empty($page_desc)){ ?>
							<p><?php jobcircle_esc_the_html($page_desc)?></p>
							<?php } ?>
						</div>
							<?php 
                        ...
                        <form class="form-search form-inline" action="<?php echo esc_url($job_select_page_url); ?>" method="get">
							<div class="fields-holder bg-white text-black d-flex flex-wrap flex-md-nowrap">
								<div class="form-group">
		                        	...
		                        	<input class="form-control" type="search" placeholder="<?php esc_html_e('What are you looking for?', 'jobcircle-frame') ?>" name="keyword">
									</div>
								</div>
								<div class="form-group">
					...
					<div class="col-12">
                        ...
                        <nav class="breadcrumb-nav text-white d-flex justify-content-center mt-20 mt-lg-40">
							<ul class="breadcrumb mb-0">
                                ...
                                <?php if(!empty($page_name)){?>
                                <li class="breadcrumb-item active"><?php jobcircle_esc_the_html($page_name)?></li>
                                <?php } ?>
							</ul>
						</nav>
					</div>
...
add_shortcode( 'blog_sub_header', 'blog_sub_header_frontend' );