<?php
   function jobcircle_discover_blog() {  
           $terms = get_terms(
		array(
			'taxonomy' => 'category',
			'hide_empty' => true,
    ...
    vc_map( 
       array(
             'name' => __( 'Discover Blog' ),
             'base' => 'jobcircle_discover_blog',
...
add_action( 'vc_before_init', 'jobcircle_discover_blog' );

// popular category frontend
function jobcircle_discover_blog_frontend( $atts, $content ) {
...
add_shortcode( 'jobcircle_discover_blog', 'jobcircle_discover_blog_frontend' );