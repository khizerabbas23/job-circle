<?php
function jobcircle_job_grid_six()
{
	vc_map(
		array(
			'name' => __('Job Grid 6'),
			'base' => 'jobcircle_job_grid_six',
...
add_action('vc_before_init', 'jobcircle_job_grid_six');
...
function jobcircle_job_grid_six_frontend($atts, $content)
{
	$atts = shortcode_atts(
		array(
			'orderby' => '',
		...
		$atts, 'jobcircle_job_grid_six'
	);
	$orderby = isset($atts['orderby']) ? $atts['orderby'] : '';
	$numofpost = isset($atts['numofpost']) ? $atts['numofpost'] : '';
	$atts['listin_ajax_action'] = 'jobcircle_jobs_grid_six_all';
				...
				<div class="row <?php echo esc_html($sidebaralign); ?>">
					...
					<div class="col-12 col-lg-8 col-xxl-9">
						...
						<div class="row justify-content-center  jobcircle-alljobs-list">
							<?php echo jobcircle_jobs_grid_six($atts); ?>
						</div>
					</div>
				</div>
			</div>
...
add_shortcode('jobcircle_job_grid_six', 'jobcircle_job_grid_six_frontend');
function jobcircle_jobs_grid_six($atts)
{
	ob_start();
				...
				<div class="col-12 mb-15 mb-md-30">
					...
					<div class="jobs-card">
						<div class="job-content-left">
							...
							<?php }
							if (!empty($author_profile_link) && !empty($post_author_name)) { ?>
								<span class="meta">
									<?php esc_html_e('By', 'jobcircle-frame') ?> <a href="<?php echo esc_html($author_profile_link) ?>"
										class="myclass">
						...
						<div class="job-content-right">
							...
							<div class="jobcircle-aplybtn-con">
								<a href="javascript:;" class="jobcircle-det-applybtn jobdet-applybtn-act btn btn btn-green"
									data-id="<?php echo esc_html($job_id) ?>" data-bs-toggle="modal"
									data-bs-target="#jobcircle-apply-job-popup"><span class="btn-text">
				...
				<div class="col-12 col-sm-6 col-xxl-4 mb-15 mb-md-30">
					...
					<article class="featured-category-box">
						...
						<div class="textbox">
							...
							<a href="javascript:;"
								class="jobcircle-aplybtn-con jobcircle-det-applybtn jobdet-applybtn-act btn btn-dark-yellow btn-sm"
								data-id="<?php echo esc_html($post); ?>" data-bs-toggle="modal"
								data-bs-target="#jobcircle-apply-job-popup"><span class="btn-text"><span class="text">
										<?php esc_html_e('Apply Now', 'jobcircle-frame'); ?>
...
add_action('wp_ajax_jobcircle_jobs_grid_six_all', 'jobcircle_jobs_grid_six_all');
add_action('wp_ajax_nopriv_jobcircle_jobs_grid_six_all', 'jobcircle_jobs_grid_six_all');
function jobcircle_jobs_grid_six_all()
{
	$atts = array(
		'numofpost' => $_POST['numposts'],
		'orderby' => $_POST['orderby']
	);
	$html = jobcircle_jobs_grid_six($atts);
