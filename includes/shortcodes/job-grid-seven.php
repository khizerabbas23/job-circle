					...
					<aside class="filters-sidebar custom-filters">
						<form method="post" class="jobcircle-jobfilter-form">
							...
							<div class="filter-buttons">
								...
								<input type="hidden" name="action" value="jobcircle_jobs_grid_sev_ajax"><a href="#" class="btn btn-green btn-sm"><span class="btn-text"><?php esc_html_e('Apply Filter', 'jobcircle-frame') ?></span></a>
						...
						<article class="featured-category-box">
							...
							<div class="textbox">
								...
								if (!empty($post_author_url) && !empty($post_author_name)) {	?>
									<span class="subtitle"><?php esc_html_e('By', 'jobcircle-frame') ?> <a href="<?php echo esc_html($post_author_url); ?>" class="myclass"><?php echo esc_html($post_author_name); ?></a></span>
								<?php  }
