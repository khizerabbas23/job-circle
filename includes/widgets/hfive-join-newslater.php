 ...
 */
if (!class_exists('hfive_newslater')) {

    class hfive_newslater extends WP_Widget
    {
        /**
        ...
        public function __construct()
        {
            parent::__construct(
                'hfive_newslater',
                // Base ID.
                __('Hfive Join Newslater', 'jobcircle-frame'),
                // Name.
                array('classname' => 'widget_footer_newsletter', 'description' => __('Join Newsletter Checking', 'jobcircle-frame'))
            );
        }
...
add_action('widgets_init', function () {
    return register_widget("hfive_newslater");
});