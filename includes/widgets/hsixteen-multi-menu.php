 ...
 */
if (!class_exists('jobcircle_multi_menu_hsixteen')) {

    class jobcircle_multi_menu_hsixteen extends WP_Widget
    {
        /**
        ...
        {
            parent::__construct(
                'jobcircle_multi_menu_hsixteen', // Base ID.
                __('Hsixteen Multi Menu', 'jobcircle-frame'), // Name.
...
add_action('widgets_init', function () {
    return register_widget("jobcircle_multi_menu_hsixteen");
});