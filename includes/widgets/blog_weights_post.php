 ...
 */
if (!class_exists('jobcircle_blog_weights_posts')) {

    class jobcircle_blog_weights_posts extends WP_Widget
    {
        /**
        ...
        {
            parent::__construct(
                'jobcircle_blog_weights_posts',
                // Base ID.
                __('Blog Widgets Posts', 'base-frame'),
                // Name.
                array('classname' => 'widget_footer_contact', 'description' => __('Blog  Widgets Posts.', 'base-frame'))
            );
        }
                                   ...
                                   <li>
										<div class="thumbnail">
											<a href="<?php echo esc_html($permalinkget) ?>">
												<img src="<?php echo esc_url_raw($image[0]) ?>" width="66" height="66" alt="JobCircle">
											</a>
										</div>
										<div class="textbox">
...
add_action('widgets_init', function () {
    return register_widget("jobcircle_blog_weights_posts");
});