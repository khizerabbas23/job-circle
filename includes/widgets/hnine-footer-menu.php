 ...
 */
if (!class_exists('jobcircle_footer_menu_hnine')) {

    class jobcircle_footer_menu_hnine extends WP_Widget
    {
        /**
        ...
        {
            parent::__construct(
                'jobcircle_footer_menu_hnine', // Base ID.
                __('H-Nine Footer Menu', 'jobcircle-frame'), // Name.
...
add_action('widgets_init', function () {
    return register_widget("jobcircle_footer_menu_hnine");
});