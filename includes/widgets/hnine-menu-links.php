 ...
 */
if (!class_exists('jc_footer_nine_menu_links')) {

    class jc_footer_nine_menu_links extends WP_Widget
    {
        /**
        ...
        {
            parent::__construct(
                'jc_footer_nine_menu_links',
                // Base ID.
                __('Hnine Menu Links', 'jobcircle-frame'),
                // Name.
...
<div class="footer-links-holder">
								<div class="row">
									<div class="col-6">
            <strong class="h5"><?php echo jobcircle_esc_the_html($title) ?></strong>
            <?php
            ...
            ?>
									...
									<div class="col-6">
										<strong class="h5"><?php echo jobcircle_esc_the_html($scnd_title) ?></strong>
                                        <?php
                                        if ($nav_itm != '') {
...
add_action('widgets_init', function () {
    return register_widget("jc_footer_nine_menu_links");
});