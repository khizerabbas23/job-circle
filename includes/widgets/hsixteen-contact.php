 ...
 */
if (!class_exists('hsixteen_contact')) {

    class hsixteen_contact extends WP_Widget
    {
        /**
        ...
        public function __construct()
        {
            parent::__construct(
                'hsixteen_contact',
                // Base ID.
                __('Hsixteen CONTACT', 'jobcircle-frame'),
                // Name.
        ...
        function form($instance)
        {
            ...
            $mail_img = isset($instance['mail_img']) ? esc_attr($instance['mail_img']) : '';
            $phone_img = isset($instance['phone_img']) ? esc_attr($instance['phone_img']) : '';
            $loc_img = isset($instance['loc_img']) ? esc_attr($instance['loc_img']) : '';
            ...
            <div class="jobcircle-frame-element-field text-widget-fields">
                ...
                <p>
                    <label>
                     <?php esc_html_e('Mail Image', 'jobcircle-frame') ?>
                    </label>
                    <input type="text" name="<?php echo ($this->get_field_name('mail_img')) ?>"
                     value="<?php echo ($mail_img) ?>">
                </p>
                <p>
                    <label>
                     <?php esc_html_e('Phone Image', 'jobcircle-frame') ?>
                    </label>
                    <input type="text" name="<?php echo ($this->get_field_name('phone_img')) ?>"
                     value="<?php echo ($phone_img) ?>">
                </p>
                <p>
                    <label>
                     <?php esc_html_e('Location Image', 'jobcircle-frame') ?>
                    </label>
                    <input type="text" name="<?php echo ($this->get_field_name('loc_img')) ?>"
                     value="<?php echo ($loc_img) ?>">
                </p>
        ...
        function update($new_instance, $old_instance)
        {
            ...
            $instance['mail_img'] = $new_instance['mail_img'];
            $instance['phone_img'] = $new_instance['phone_img'];
            $instance['loc_img'] = $new_instance['loc_img'];
...
<div class="contact_info_holder">
								<strong class="h5"><?php echo esc_html($contact_heading)?></strong>
								<ul class="contact-info-list">
									<li>
										<div class="icon-left">
											<img src="<?php echo esc_url_raw($mail_img)?>" alt="icon">
										</div>
										<span class="sub-text"><a href="<?php esc_html_e('mailto:','jobcircle-frame')?> <?php echo esc_html($contact_email)?>"><?php echo esc_html($contact_email)?></a></span>
									</li>
									<li>
										<div class="icon-left">
											<img src="<?php echo esc_url_raw($phone_img)?>" alt="icon">
										</div>
										<span class="sub-text"><a href="<?php esc_html_e('tel:','jobcircle-frame')?> <?php echo esc_html($contact_phone)?>"><?php echo esc_html($contact_phone)?></a></span>
									</li>
									<li>
										<div class="icon-left">
											<img src="<?php echo esc_url_raw($loc_img)?>" alt="icon">
										</div>
										<span class="sub-text"><?php echo esc_html($contact_location)?></span>
									</li>
								</ul>
							</div>
...
add_action('widgets_init', function () {
    return register_widget("hsixteen_contact");
});