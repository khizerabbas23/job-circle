 ...
 */
if (!class_exists('Jobcircle_footer_gallery')) {

    class Jobcircle_footer_gallery extends WP_Widget
    {
        /**
        ...
        {
            parent::__construct(
                'Jobcircle_footer_gallery',
                // Base ID.
                __('GALLERY', 'base-frame'),
                // Name.
                array('classname' => 'widget_footer_contact', 'description' => __('Footer gallery is here.', 'base-frame'))
            );
        }
   ...
   ?>
          <h5 class="h4"><?php echo jobcircle_esc_the_html($post_heading)?></h5>
							<ul class="gallery-list pe-xl-70">
                    ...
                    if ($query->have_posts()) {
                        ...
                        while ($query->have_posts()) {
                            ...
                            ?>
                                    ...
                                    <li><a href="<?php echo jobcircle_esc_the_html($image[0]); ?>" data-fancybox="gallery"><img src="<?php echo jobcircle_esc_the_html($image[0]); ?>" width="166" height="125" alt="Image Gallery"></a></li>
...
add_action('widgets_init', function () {
    return register_widget("Jobcircle_footer_gallery");
});