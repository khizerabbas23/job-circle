 ...
 */
if (!class_exists('jc_footer_sixty_suport_menu')) {

    class jc_footer_sixty_suport_menu extends WP_Widget
    {
        /**
        ...
        {
            parent::__construct(
                'jc_footer_sixty_suport_menu',
                // Base ID.
                __('Hsixty Support Menu Links', 'jobcircle-frame'),
                // Name.
...
add_action('widgets_init', function () {
    return register_widget("jc_footer_sixty_suport_menu");
});