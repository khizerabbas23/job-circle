 ...
 */
if (!class_exists('height_newslater')) {

    class height_newslater extends WP_Widget
    {
        /**
        ...
        public function __construct()
        {
            parent::__construct(
                'height_newslater',
                // Base ID.
                __('Height NEWSLETTER', 'jobcircle-frame'),
                // Name.
        ...
        function form($instance)
        {
            ...
            <div class="jobcircle-frame-element-field text-widget-fields">
                <p>
                    <label>
                        <?php esc_html_e('Newsletter Title', 'jobcircle-frame') ?>
                    </label>
                ...
                <p>
                    ...
                    <input type="text" name="<?php echo ($this->get_field_name('news_btn')) ?>"
                        value="<?php echo ($news_btn) ?>">
                </p>
                 <p>
                    <label>
...
add_action('widgets_init', function () {
    return register_widget("height_newslater");
});