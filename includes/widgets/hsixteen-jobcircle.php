 ...
 */
if (!class_exists('jobcircle_hsixteen')) {

    class jobcircle_hsixteen extends WP_Widget
    {
        /**
        ...
        public function __construct()
        {
            parent::__construct(
                'jobcircle_hsixteen',
                // Base ID.
                __('Hsixteen JobCircle', 'jobcircle-frame'),
                // Name.
            ...
            ?>    
							<div class="social-links-holder">
								<div class="footer-logo">
									<a href="<?php home_url() ?>"><img src="<?php echo esc_url_raw($logo)?>" alt="logo"></a>
								</div>
								<p><?php echo esc_html($shortdesc)?></p>
								<ul class="social_icons">
									<li>
										<a href="<?php echo esc_html($fb_url)?>"><i class="jobcircle-icon-facebook icon"></i></a>
									</li>
									<li>
										<a href="<?php echo esc_html($linkedin_url)?>"><i class="jobcircle-icon-linkedin icon"></i></a>
									</li>
									<li>
										<a href="<?php echo esc_html($youtube_url)?>"><i class="jobcircle-icon-youtube icon"></i></a>
									</li>
									<li>
										<a href="<?php echo esc_html($instgrm_url)?>"><i class="jobcircle-icon-instagram icon"></i></a>
									</li>
								</ul>
							</div>
...
add_action('widgets_init', function () {
    return register_widget("jobcircle_hsixteen");
});