 ...
 */
if (!class_exists('hsix_footer_widget')) {

    class hsix_footer_widget extends WP_Widget
    {
        /**
        ...
        public function __construct()
        {
            parent::__construct(
                'hsix_footer_widget',
                // Base ID.
                __('Hsix Footer Description', 'jobcircle-frame'),
                // Name.
...
add_action('widgets_init', function () {
    return register_widget("hsix_footer_widget");
});