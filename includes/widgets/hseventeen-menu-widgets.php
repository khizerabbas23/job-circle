 ...
 */
if (!class_exists('hseventeen_footer_menu')) {

    class hseventeen_footer_menu extends WP_Widget
    {
        /**
        ...
        {
            parent::__construct(
                'hseventeen_footer_menu', // Base ID.
                __('HSeventeen Multi Menu', 'jobcircle-frame'), // Name.
...
add_action('widgets_init', function () {
    return register_widget("hseventeen_footer_menu");
});