...
$results = JOBCIRCLE_CFS()->api->get_input_fields( [ 'group_id' => $post->ID ] );
...
<div class="table_footer">
    <input type="button" class="button-primary cstmfield_add_field" value="<?php _e('Add New Field', 'jobcircle-frame'); ?>" />
</div>
