...
(function($) {
    $(function() {
        ...
        $('#button-reset').click(function() {
            if (confirm('This will delete all JOBCIRCLE_CFS data. Are you sure?')) {
                $.post(ajaxurl, {
                    action: 'cstmfield_ajax_handler',
                    action_type: 'reset',
                    nonce: cstmfield_nonce
...
<div class="wrap">
    <h1><?php _e( 'Tools', 'jobcircle-frame' ); ?></h1>

    <h3 class="nav-tab-wrapper">
        <a class="nav-tab nav-tab-active" rel="export"><?php _e('Export', 'jobcircle-frame'); ?></a>
        <a class="nav-tab" rel="import"><?php _e('Import', 'jobcircle-frame'); ?></a>
        <a class="nav-tab" rel="reset"><?php _e('Reset', 'jobcircle-frame'); ?></a>
    </h3>
    ...
    <div class="content-container">
            ...
            <table>
                <tr>
                    <td style="width:300px; vertical-align:top">
                        ...
                        <div>
                            <input type="button" id="button-export" class="button" value="<?php _e('Export', 'jobcircle-frame'); ?>" />
                        </div>
                    </td>
                    <td style="width:300px; vertical-align:top">
        ...
        <div class="tab-content import">
            ...
            <div><input type="button" id="button-import" class="button" value="<?php _e('Import', 'jobcircle-frame'); ?>" /></div>
        ...
        <div class="tab-content reset">
            <h2><?php _e('Reset and deactivate.', 'jobcircle-frame'); ?></h2>
            <p><?php _e('This will delete all JOBCIRCLE_CFS data and deactivate the plugin.', 'jobcircle-frame'); ?></p>
            <input type="button" id="button-reset" class="button" value="<?php _e('Delete everything', 'jobcircle-frame'); ?>" />
        </div>
    </div>
</div>
