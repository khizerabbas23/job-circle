...
class cstmfield_term extends cstmfield_field
{
    ...
    function __construct() {
        $this->name = 'term';
        $this->label = __( 'Term', 'jobcircle-frame' );
    }
    ...
    ?>
        <div class="filter_posts">
            <input type="text" class="cstmfield_filter_input" autocomplete="off" placeholder="<?php _e( 'Search terms', 'jobcircle-frame' ); ?>" />
        </div>
    ...
    ?>
        <tr class="field_option field_option_<?php echo $this->name; ?>">
            <td class="label">
                <label><?php _e('Taxonomies', 'jobcircle-frame'); ?></label>
                <p class="description"><?php _e('Limit terms to the following taxonomies', 'jobcircle-frame'); ?></p>
            </td>
            <td>
                <?php
