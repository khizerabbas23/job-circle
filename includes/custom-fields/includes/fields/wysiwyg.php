...
class cstmfield_wysiwyg extends cstmfield_field
{
    ...
    function __construct() {
        $this->name = 'wysiwyg';
        $this->label = __( 'Wysiwyg Editor', 'jobcircle-frame' );
    ...
    ?>
        <tr class="field_option field_option_<?php echo $this->name; ?>">
            <td class="label">
                <label><?php _e( 'Formatting', 'jobcircle-frame' ); ?></label>
            </td>
            <td>
                <?php
                    JOBCIRCLE_CFS()->create_field( [
                        ...
                        'options' => [
                            'choices' => [
                                'default' => __( 'Default', 'jobcircle-frame' ),
                                'none' => __( 'None (bypass filters)', 'jobcircle-frame' )
                            ],
                            'force_single' => true,
                        ],
    ...
    function mce_external_plugins( $plugins ) {
        if ( version_compare( get_bloginfo( 'version' ), '3.9', '>=' ) ) {
            $plugins['code'] = JOBCIRCLE_CFS_URL . '/assets/js/tinymce/code.min.js';
        }
        return $plugins;
    }
