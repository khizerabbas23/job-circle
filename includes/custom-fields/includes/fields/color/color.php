...
class cstmfield_color extends cstmfield_field
{
    ...
    function __construct() {
        $this->name = 'color';
        $this->label = __( 'Color', 'jobcircle-frame' );
    }
    ...
    function input_head( $field = null ) {
        wp_register_script( 'miniColors', JOBCIRCLE_CFS_URL . '/includes/fields/color/jquery.miniColors.min.js' );
        wp_enqueue_script( 'miniColors' );
    ?>
        <link rel="stylesheet" type="text/css" href="<?php echo JOBCIRCLE_CFS_URL; ?>/includes/fields/color/color.css" />
        <script>
        (function($) {
