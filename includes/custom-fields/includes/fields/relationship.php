...
class cstmfield_relationship extends cstmfield_field
{
    ...
    function __construct() {
        ...
        $this->label = __( 'Relationship', 'jobcircle-frame' );
    }
    ...
    ?>
        <div class="filter_posts">
            <input type="text" class="cstmfield_filter_input" autocomplete="off" placeholder="<?php _e( 'Search posts', 'jobcircle-frame' ); ?>" />
        </div>
    ...
    ?>
        <tr class="field_option field_option_<?php echo $this->name; ?>">
            <td class="label">
                <label><?php _e('Post Types', 'jobcircle-frame'); ?></label>
                <p class="description"><?php _e('Limit posts to the following types', 'jobcircle-frame'); ?></p>
            </td>
            <td>
                <?php
