...
add_action('wp_ajax_jobcircle_delete_post_emply', 'jobcircle_delete_post_emply');
add_action('wp_ajax_nopriv_jobcircle_delete_post_emply', 'jobcircle_delete_post_emply');
function jobcircle_delete_post_emply() {
