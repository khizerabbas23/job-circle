...
(function ($) {
  ...
  /* slider 1 */
  if(jQuery(".testimonial-slider1").length){
    $('.testimonial-slider1').slick(testimonialSlider1);
  }
  /* slider 2 */
  if(jQuery(".testimonial-slider2").length){
    $('.testimonial-slider2').slick(testimonialSlider2);
  }
  /* slider 3 */
  if(jQuery(".testimonial-slider3-for").length){
    $('.testimonial-slider3-for').slick(testimonialSliderFor);
  }
  /* slider 4 */
  if(jQuery(".testimonial-slider3-nav").length){
    $('.testimonial-slider3-nav').slick(testimonialSliderNav);
  }
  /* slider 5 */
  if(jQuery(".testimonial-slider4").length){
  ...
  if (document.getElementsByClassName('slick-slider')) {
    ...
    $(document).ready(function () {
      ...
      if(jQuery(".global-slider").length > 0){
        var globalSlider = {
          dots: true,
          arrows: false,
        }
  ...
  /* Popup gallery */
  if(jQuery(".ap-post-gallery").length){
  ...
  /* Star Rating Basic */
    if (typeof $.fn.starRating === 'function') {
